...
public interface ISidlParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitField([NotNull] SidlParser.FieldContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="SidlParser.fieldlist"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFieldlist([NotNull] SidlParser.FieldlistContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitQuery([NotNull] SidlParser.QueryContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="SidlParser.comparator"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitComparator([NotNull] SidlParser.ComparatorContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitSurrogatebody([NotNull] SidlParser.SurrogatebodyContext context);
	/// <summary>
